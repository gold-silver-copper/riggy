...
pub use riggy_ontology::terms::{
    DependentContinuant, DispositionKind, DispositionNode, EntityKind, OccurrentKind, PlaceKind,
    QualityKind, QualityNode, RiggyUniversal, RoleKind, RoleNode, RouteKind, TravelRoute,
};
